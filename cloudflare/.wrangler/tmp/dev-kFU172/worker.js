...
// worker.js
var STREAMLIT_APP = "https://datapipeline-pro.streamlit.app";
var EMBED_URL = `${STREAMLIT_APP}/?embed=true&embed_options=show_toolbar,show_padding,show_colored_line`;
var HTML = `<!DOCTYPE html>
<html lang="pt-BR">
<head>
<meta charset="UTF-8" />
<meta name="viewport" content="width=device-width, initial-scale=1.0" />
<title>DataPipeline Pro \u2014 An\xE1lise de Dados</title>
<style>
  :root { color-scheme: dark; }
  * { margin: 0; padding: 0; box-sizing: border-box; }
  /* 100dvh acompanha a viewport real no mobile (barra de endere\xE7o); 100% \xE9 o fallback */
  html, body { height: 100%; height: 100dvh; background: #0b1120; overflow: hidden; }
  body { display: flex; flex-direction: column; }
  /* Barra fina com o dom\xEDnio pr\xF3prio (opcional) */
  .barra {
...
<body>
  <div class="barra">
    ...
    <span>engenharia de dados \xB7 python \xB7 sql</span>
  </div>
...
// .wrangler/tmp/bundle-mGcpBh/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-mGcpBh/middleware-loader.entry.ts
